...
- [CRI-O completes second OSTIF audit](https://www.cncf.io/blog/2026/01/16/cri-o-completes-second-ostif-audit/) - *Blog – Cloud Native Computing Foundation* (2026-01-16)
- [KubeCon + CloudNativeCon NA: Top sessions from the CNCF End User TAB](https://www.cncf.io/blog/2026/01/15/kubecon-cloudnativecon-na-top-sessions-from-the-cncf-end-user-tab/) - *Blog – Cloud Native Computing Foundation* (2026-01-15)
- [The symbiotic revolution: AI and cloud native technologies transforming the digital landscape](https://www.cncf.io/blog/2026/01/13/the-symbiotic-revolution-ai-and-cloud-native-technologies-transforming-the-digital-landscape/) - *Blog – Cloud Native Computing Foundation* (2026-01-13)
- [A decade of open source in CNCF with 300,000+ contributors and counting](https://www.cncf.io/blog/2026/01/12/a-decade-of-open-source-in-cncf-with-300000-contributors-and-counting/) - *Blog – Cloud Native Computing Foundation* (2026-01-12)
- [OpenCost: Reflecting on 2025 and looking ahead to 2026](https://www.cncf.io/blog/2026/01/12/opencost-reflecting-on-2025-and-looking-ahead-to-2026/) - *Blog – Cloud Native Computing Foundation* (2026-01-12)
...
- [Patch Tuesday, January 2026 Edition](https://krebsonsecurity.com/2026/01/patch-tuesday-january-2026-edition/) - *Krebs on Security* (2026-01-14)
...
- [Robert Haas: Hacking Workshop for February 2026](https://postgr.es/p/7qq) - *Planet PostgreSQL* (2026-01-15)
...
- [IP Fabric 7.9 boosts visibility across hybrid environments](https://www.networkworld.com/article/4118128/ip-fabric-7-9-boosts-visibility-across-hybrid-environments.html) - *IP Fabric 7.9 boosts visibility across hybrid environments | Network World* (2026-01-16)
- [Cisco finally patches seven-week-old zero-day flaw in Secure Email Gateway products](https://www.networkworld.com/article/4118154/cisco-finally-patches-seven-week-old-zero-day-flaw-in-secure-email-gateway-products.html) - *IP Fabric 7.9 boosts visibility across hybrid environments | Network World* (2026-01-16)
- [Enterprise Spotlight: Setting the 2026 IT agenda](https://us.resources.networkworld.com/resources/download-the-2026-it-agenda-spotlight-report/) - *IP Fabric 7.9 boosts visibility across hybrid environments | Network World* (2026-01-16)
- [The perfect certificate migration until it wasn’t: How certificates can break RADIUS trusts](https://www.networkworld.com/article/4117480/the-perfect-certificate-migration-until-it-wasnt-how-certificates-can-break-radius-trusts.html) - *IP Fabric 7.9 boosts visibility across hybrid environments | Network World* (2026-01-16)
- [Palo Alto Networks patches firewalls after discovery of a new denial-of-service flaw](https://www.networkworld.com/article/4117630/palo-alto-networks-patches-firewalls-after-discovery-of-a-new-denial-of-service-flaw.html) - *IP Fabric 7.9 boosts visibility across hybrid environments | Network World* (2026-01-16)
...
- [Advanced fine-tuning techniques for multi-agent orchestration: Patterns from Amazon at scale](https://aws.amazon.com/blogs/machine-learning/advanced-fine-tuning-techniques-for-multi-agent-orchestration-patterns-from-amazon-at-scale/) - *Artificial Intelligence* (2026-01-16)
- [How Palo Alto Networks enhanced device security infra log analysis with Amazon Bedrock](https://aws.amazon.com/blogs/machine-learning/how-palo-alto-networks-enhanced-device-security-infra-log-analysis-with-amazon-bedrock/) - *Artificial Intelligence* (2026-01-16)
- [From beginner to champion: A student’s journey through the AWS AI League ASEAN finals](https://aws.amazon.com/blogs/machine-learning/from-beginner-to-champion-a-students-journey-through-the-aws-ai-league-asean-finals/) - *Artificial Intelligence* (2026-01-16)
- [Deploy AI agents on Amazon Bedrock AgentCore using GitHub Actions](https://aws.amazon.com/blogs/machine-learning/deploy-ai-agents-on-amazon-bedrock-agentcore-using-github-actions/) - *Artificial Intelligence* (2026-01-16)
- [How the Amazon AMET Payments team accelerates test case generation with Strands Agents](https://aws.amazon.com/blogs/machine-learning/how-the-amazon-amet-payments-team-accelerates-test-case-generation-with-strands-agents/) - *Artificial Intelligence* (2026-01-15)
