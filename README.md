...
- [Kubernetes v1.35: Timbernetes (The World Tree Release)](https://kubernetes.io/blog/2025/12/17/kubernetes-v1-35-release/) - *Kubernetes Blog* (2025-12-17)
...
- [Pavel Stehule: fresh dll of orafce and plpgsql_check for PostgreSQL 17 and PostgreSQL 18](https://postgr.es/p/7ou) - *Planet PostgreSQL* (2025-12-20)
- [Mayur B.: The OOM-Killer Summoning Ritual: “Just Increase work_mem”](https://postgr.es/p/7ov) - *Planet PostgreSQL* (2025-12-19)
- [Dave Page: Code Signing fun and games for pgAdmin](https://postgr.es/p/7ob) - *Planet PostgreSQL* (2025-12-19)
- [Ahsan Hadi: pgEdge-Support-for-Large-Object-Logical-Replication](https://postgr.es/p/7oc) - *Planet PostgreSQL* (2025-12-19)
- [Dave Page: RAG Servers vs MCP Servers: Choosing the Right Approach for AI-Powered Database Access](https://postgr.es/p/7od) - *Planet PostgreSQL* (2025-12-19)
...
- [Unlock the power of distributed graph databases with JanusGraph and Azure Apache Cassandra](https://devblogs.microsoft.com/cosmosdb/janusgraph-azure-cassandra-graph-databases/) - *Azure Cosmos DB Blog* (2025-12-17)
- [Improve Aurora PostgreSQL throughput by up to 165% and price-performance ratio by up to 120% using Optimized Reads on AWS Graviton4-based R8gd instances](https://aws.amazon.com/blogs/database/improve-aurora-postgresql-throughput-by-up-to-165-and-price-performance-ratio-by-up-to-120-using-optimized-reads-on-aws-graviton4-based-r8gd-instances/) - *AWS Database Blog* (2025-12-17)
- [Why Regeneron chose Amazon RDS Custom for Oracle to deploy COTS and GxP applications on AWS](https://aws.amazon.com/blogs/database/why-regeneron-chose-amazon-rds-custom-for-oracle-to-deploy-cots-and-gxp-applications-on-aws/) - *AWS Database Blog* (2025-12-16)
...
- [WatchGuard fixes ‘critical’ zero-day allowing firewall takeover](https://www.networkworld.com/article/4109921/watchguard-fixes-critical-zero-day-allowing-firewall-takeover-2.html) - *WatchGuard fixes ‘critical’ zero-day allowing firewall takeover | Network World* (2025-12-19)
- [Attackers bring their own passwords to Cisco and Palo Alto VPNs](https://www.networkworld.com/article/4109637/attackers-bring-their-own-passwords-to-cisco-and-palo-alto-vpns-2.html) - *WatchGuard fixes ‘critical’ zero-day allowing firewall takeover | Network World* (2025-12-19)
- [Cisco: Latest news and insights](https://www.networkworld.com/article/3523958/cisco-latest-news-and-insights.html) - *WatchGuard fixes ‘critical’ zero-day allowing firewall takeover | Network World* (2025-12-19)
- [Snowflake software update caused 13-hour outage across 10 regions](https://www.networkworld.com/article/4109595/snowflake-software-update-caused-13-hour-outage-across-10-regions-2.html) - *WatchGuard fixes ‘critical’ zero-day allowing firewall takeover | Network World* (2025-12-19)
- [HPE OneView vulnerable to remote code execution attack](https://www.networkworld.com/article/4109180/hpe-oneview-vulnerable-to-remote-code-execution-attack-2.html) - *WatchGuard fixes ‘critical’ zero-day allowing firewall takeover | Network World* (2025-12-19)
...
- [Introducing GPT-5.2-Codex](https://openai.com/index/introducing-gpt-5-2-codex) - *OpenAI News* (2025-12-18)
...
- [Gemini 3 Flash: frontier intelligence built for speed](https://deepmind.google/blog/gemini-3-flash-frontier-intelligence-built-for-speed/) - *Google DeepMind News* (2025-12-17)
- [Gemma Scope 2: helping the AI safety community deepen understanding of complex language model behavior](https://deepmind.google/blog/gemma-scope-2-helping-the-ai-safety-community-deepen-understanding-of-complex-language-model-behavior/) - *Google DeepMind News* (2025-12-16)

## AI Infra

- [Introducing SOCI indexing for Amazon SageMaker Studio: Faster container startup times for AI/ML workloads](https://aws.amazon.com/blogs/machine-learning/introducing-soci-indexing-for-amazon-sagemaker-studio-faster-container-startup-times-for-ai-ml-workloads/) - *Artificial Intelligence* (2025-12-19)
- [Build and deploy scalable AI agents with NVIDIA NeMo, Amazon Bedrock AgentCore, and Strands Agents](https://aws.amazon.com/blogs/machine-learning/build-and-deploy-scalable-ai-agents-with-nvidia-nemo-amazon-bedrock-agentcore-and-strands-agents/) - *Artificial Intelligence* (2025-12-18)
- [Bi-directional streaming for real-time agent interactions now available in Amazon Bedrock AgentCore Runtime](https://aws.amazon.com/blogs/machine-learning/bi-directional-streaming-for-real-time-agent-interactions-now-available-in-amazon-bedrock-agentcore-runtime/) - *Artificial Intelligence* (2025-12-18)
- [Tracking and managing assets used in AI development with Amazon SageMaker AI](https://aws.amazon.com/blogs/machine-learning/tracking-and-managing-assets-used-in-ai-development-with-amazon-sagemaker-ai/) - *Artificial Intelligence* (2025-12-17)
- [Track machine learning experiments with MLflow on Amazon SageMaker using Snowflake integration](https://aws.amazon.com/blogs/machine-learning/track-machine-learning-experiments-with-mlflow-on-amazon-sagemaker-using-snowflake-integration/) - *Artificial Intelligence* (2025-12-17)
