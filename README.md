...
- [From global stages to a local landmark: Organizing KCD Sri Lanka 2025](https://www.cncf.io/blog/2026/01/29/from-global-stages-to-a-local-landmark-organizing-kcd-sri-lanka-2025/) - *Blog – Cloud Native Computing Foundation* (2026-01-29)
...
- [Introducing Kthena: LLM inference for the cloud native era](https://www.cncf.io/blog/2026/01/28/introducing-kthena-llm-inference-for-the-cloud-native-era/) - *Blog – Cloud Native Computing Foundation* (2026-01-28)
...
- [Introducing NVIDIA Cosmos Policy for Advanced Robot Control](https://huggingface.co/blog/nvidia/cosmos-policy-for-robot-control) - *Hugging Face - Blog* (2026-01-29)
- [Project Genie: Experimenting with infinite, interactive worlds](https://deepmind.google/blog/project-genie-experimenting-with-infinite-interactive-worlds/) - *Google DeepMind News* (2026-01-29)
- [Inside OpenAI’s in-house data agent](https://openai.com/index/inside-our-in-house-data-agent) - *OpenAI News* (2026-01-29)
- [Taisei Corporation shapes the next generation of talent with ChatGPT](https://openai.com/index/taisei) - *OpenAI News* (2026-01-29)
...
- [Evaluating generative AI models with Amazon Nova LLM-as-a-Judge on Amazon SageMaker AI](https://aws.amazon.com/blogs/machine-learning/evaluating-generative-ai-models-with-amazon-nova-llm-as-a-judge-on-amazon-sagemaker-ai/) - *Artificial Intelligence* (2026-01-30)
- [Simplify ModelOps with Amazon SageMaker AI Projects using Amazon S3-based templates](https://aws.amazon.com/blogs/machine-learning/simplify-modelops-with-amazon-sagemaker-ai-projects-using-amazon-s3-based-templates/) - *Artificial Intelligence* (2026-01-30)
- [Scale AI in South Africa using Amazon Bedrock global cross-Region inference with Anthropic Claude 4.5 models](https://aws.amazon.com/blogs/machine-learning/scale-ai-in-south-africa-using-amazon-bedrock-global-cross-region-inference-with-anthropic-claude-4-5-models/) - *Artificial Intelligence* (2026-01-30)
- [Scaling content review operations with multi-agent workflow](https://aws.amazon.com/blogs/machine-learning/scaling-content-review-operations-with-multi-agent-workflow/) - *Artificial Intelligence* (2026-01-29)
